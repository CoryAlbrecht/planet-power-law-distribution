...
def run_numpyro_slice_weighted(
    ...
    # Copy the two arrays we need into plain numpy immediately.
    # samples also holds x_true (shape: num_samples × N), pi, mu_k, sig_k,
    ...
    del mcmc  # frees NUTS internal state and warmup trace
